...
# Icon .png
PRODUCTION_MACOS_ICON := Apps-Gnome-Mines-icon

PRODUCTION_DEPENDENCIES := \
	$(PRODUCTION_DEPENDENCIES)

PRODUCTION_MACOS_BUNDLE_DEVELOPER := DreadArceus
PRODUCTION_MACOS_BUNDLE_DISPLAY_NAME := Minesweeper
PRODUCTION_MACOS_BUNDLE_NAME := Minesweeper
